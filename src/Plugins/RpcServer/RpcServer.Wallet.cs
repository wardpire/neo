...
namespace Neo.Plugins.RpcServer
{
    partial class RpcServer
    {
        ...
        protected internal virtual JToken CalculateNetworkFee(JArray _params)
        {
            ...
            JObject account = new();
            var networkfee = Wallets.Helper.CalculateNetworkFee(tx.AsSerializable<Transaction>(), system.StoreView, system.Settings, system.NativeContractRepository, wallet);
