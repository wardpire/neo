...
namespace Neo.Network.P2P.Payloads
{
    ...
    public abstract class TransactionAttribute : ISerializable
    {
        ...
        public virtual bool Verify(DataCache snapshot, Transaction tx, NativeContractRepository nativeContractRepository) => true;

        public virtual long CalculateNetworkFee(DataCache snapshot, Transaction tx, NativeContractRepository nativeContractRepository) => nativeContractRepository.Policy.GetAttributeFee(snapshot, (byte)Type);
    }
}
