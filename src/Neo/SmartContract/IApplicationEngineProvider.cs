...
namespace Neo.SmartContract
{
    ...
    public interface IApplicationEngineProvider
    {
        ...
        ApplicationEngine Create(TriggerType trigger, IVerifiable container, DataCache snapshot, Block persistingBlock, ProtocolSettings settings, long gas, IDiagnostic diagnostic, JumpTable jumpTable, NativeContractRepository? nativeContractRepository = null);
    }
}
