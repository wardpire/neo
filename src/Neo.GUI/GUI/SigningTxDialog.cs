...
namespace Neo.GUI
{
    internal partial class SigningTxDialog : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            ContractParametersContext context = ContractParametersContext.Parse(textBox1.Text, Service.NeoSystem.StoreView, Service.NeoSystem.NativeContractRepository);
        ...
        {
            ContractParametersContext context = ContractParametersContext.Parse(textBox2.Text, Service.NeoSystem.StoreView, Service.NeoSystem.NativeContractRepository);
