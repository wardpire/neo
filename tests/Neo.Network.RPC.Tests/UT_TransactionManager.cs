...
namespace Neo.Network.RPC.Tests
{
    ...
    public class UT_TransactionManager
    {
        ...
        public static Mock<RpcClient> MockRpcClient(UInt160 sender, byte[] script)
        {
            ...
            // MockGasBalance
            byte[] balanceScript = mockRpc.Object.NativeContractRepository.GAS.Hash.MakeScript("balanceOf", sender);
            ...
            // MockFeePerByte
            byte[] policyScript = mockRpc.Object.NativeContractRepository.Policy.Hash.MakeScript("getFeePerByte");
        ...
        public static Mock<RpcClient> MockMultiSig(UInt160 multiHash, byte[] script)
        {
            ...
            // MockGasBalance
            byte[] balanceScript = mockRpc.Object.NativeContractRepository.GAS.Hash.MakeScript("balanceOf", multiHash);
            var balanceResult = new ContractParameter() { Type = ContractParameterType.Integer, Value = BigInteger.Parse("10000000000000000") };
