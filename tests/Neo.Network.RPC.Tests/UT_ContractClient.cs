...
namespace Neo.Network.RPC.Tests
{
    ...
    public class UT_ContractClient
    {
        ...
        public async Task TestInvoke()
        {
            ...
            var result = await contractClient.TestInvokeAsync(rpcClientMock.Object.NativeContractRepository.GAS.Hash, "balanceOf", UInt160.Zero);
        ...
        public async Task TestDeployContract()
        {
            ...
            {
                sb.EmitDynamicCall(rpcClientMock.Object.NativeContractRepository.ContractManagement.Hash, "deploy", new byte[1], manifest.ToJson().ToString());
                script = sb.ToArray();
            }
