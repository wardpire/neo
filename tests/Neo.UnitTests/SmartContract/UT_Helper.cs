...
namespace Neo.UnitTests.SmartContract
{
    ...
    public class UT_Helper
    {
        ...
        public void TestSignatureContractCost()
        {
            ...
            using var engine = ApplicationEngine.Create(TriggerType.Verification, tx, snapshot, TestBlockchain.TheNeoSystem.NativeContractRepository, settings: TestProtocolSettings.Default);
