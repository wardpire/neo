...
namespace Neo.UnitTests.SmartContract
{
    ...
    public class UT_Contract
    {
        ...
        public void TestSignatureRedeemScriptFee()
        {
            ...
            using (ApplicationEngine engine = ApplicationEngine.Create(TriggerType.Verification, new Transaction { Signers = Array.Empty<Signer>(), Attributes = Array.Empty<TransactionAttribute>() }, null, TestBlockchain.TheNeoSystem.NativeContractRepository, settings: TestBlockchain.TheNeoSystem.Settings))
            {
