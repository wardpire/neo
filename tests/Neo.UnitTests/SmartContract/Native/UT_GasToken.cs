...
namespace Neo.UnitTests.SmartContract.Native
{
    ...
    public class UT_GasToken
    {
        ...
        [TestMethod]
        public void Check_Name() => Assert.AreEqual(nameof(GasToken), TestBlockchain.TheNeoSystem.NativeContractRepository.GAS.Name);

        [TestMethod]
        public void Check_Symbol() => Assert.AreEqual("GAS", TestBlockchain.TheNeoSystem.NativeContractRepository.GAS.Symbol(_snapshotCache, TestBlockchain.TheNeoSystem.NativeContractRepository));

        [TestMethod]
        public void Check_Decimals() => Assert.AreEqual(8, TestBlockchain.TheNeoSystem.NativeContractRepository.GAS.Decimals(_snapshotCache, TestBlockchain.TheNeoSystem.NativeContractRepository));
        ...
        public async Task Check_BalanceOfTransferAndBurn()
        {
            ...
            Assert.IsTrue(TestBlockchain.TheNeoSystem.NativeContractRepository.NEO.Transfer(snapshot, TestBlockchain.TheNeoSystem.NativeContractRepository, from, to, BigInteger.Zero, true, persistingBlock));
            ...
            Assert.AreEqual(100000000, TestBlockchain.TheNeoSystem.NativeContractRepository.NEO.BalanceOf(snapshot, from));
            Assert.AreEqual(0, TestBlockchain.TheNeoSystem.NativeContractRepository.NEO.BalanceOf(snapshot, to));

            Assert.AreEqual(52000500_00000000, TestBlockchain.TheNeoSystem.NativeContractRepository.GAS.BalanceOf(snapshot, from));
            Assert.AreEqual(0, TestBlockchain.TheNeoSystem.NativeContractRepository.GAS.BalanceOf(snapshot, to));
            ...
            Assert.IsFalse(TestBlockchain.TheNeoSystem.NativeContractRepository.GAS.Transfer(snapshot, TestBlockchain.TheNeoSystem.NativeContractRepository, from, to, 52000500_00000000, false, persistingBlock)); // Not signed
            Assert.IsFalse(TestBlockchain.TheNeoSystem.NativeContractRepository.GAS.Transfer(snapshot, TestBlockchain.TheNeoSystem.NativeContractRepository, from, to, 52000500_00000001, true, persistingBlock)); // More than balance
            Assert.IsTrue(TestBlockchain.TheNeoSystem.NativeContractRepository.GAS.Transfer(snapshot, TestBlockchain.TheNeoSystem.NativeContractRepository, from, to, 52000500_00000000, true, persistingBlock)); // All balance

            // Balance of

            Assert.AreEqual(52000500_00000000, TestBlockchain.TheNeoSystem.NativeContractRepository.GAS.BalanceOf(snapshot, to));
            Assert.AreEqual(0, TestBlockchain.TheNeoSystem.NativeContractRepository.GAS.BalanceOf(snapshot, from));
            ...
            Assert.AreEqual(5200049999999999, TestBlockchain.TheNeoSystem.NativeContractRepository.GAS.BalanceOf(engine.SnapshotCache, to));
