...
namespace Neo.UnitTests.SmartContract.Native
{
    ...
    public class UT_StdLib
    {
        ...
        public void TestBase64Url()
        {
            ...
            {
                // Test encoding
                script.EmitDynamicCall(TestBlockchain.TheNeoSystem.NativeContractRepository.StdLib.Hash, "base64UrlEncode", "Subject=test@example.com&Issuer=https://example.com");
                script.EmitDynamicCall(TestBlockchain.TheNeoSystem.NativeContractRepository.StdLib.Hash, "base64UrlDecode", "U3ViamVjdD10ZXN0QGV4YW1wbGUuY29tJklzc3Vlcj1odHRwczovL2V4YW1wbGUuY29t");
