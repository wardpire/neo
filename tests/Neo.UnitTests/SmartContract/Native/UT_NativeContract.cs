...
namespace Neo.UnitTests.SmartContract.Native
{
    ...
    public class UT_NativeContract
    {
        ...
        public void TestActiveDeprecatedInRoleManagement()
        {
            ...
            var before = TestBlockchain.TheNeoSystem.NativeContractRepository.RoleManagement.GetContractState(settings.IsHardforkEnabled, 19);
            var after = TestBlockchain.TheNeoSystem.NativeContractRepository.RoleManagement.GetContractState(settings.IsHardforkEnabled, 20);
        ...
        public void TestNativeContractId()
        {
            ...
            Assert.AreEqual(TestBlockchain.TheNeoSystem.NativeContractRepository.ContractManagement.Id, -1);
            Assert.AreEqual(TestBlockchain.TheNeoSystem.NativeContractRepository.StdLib.Id, -2);
            Assert.AreEqual(TestBlockchain.TheNeoSystem.NativeContractRepository.CryptoLib.Id, -3);
            Assert.AreEqual(TestBlockchain.TheNeoSystem.NativeContractRepository.Ledger.Id, -4);
            Assert.AreEqual(TestBlockchain.TheNeoSystem.NativeContractRepository.NEO.Id, -5);
            Assert.AreEqual(TestBlockchain.TheNeoSystem.NativeContractRepository.GAS.Id, -6);
            Assert.AreEqual(TestBlockchain.TheNeoSystem.NativeContractRepository.Policy.Id, -7);
            Assert.AreEqual(TestBlockchain.TheNeoSystem.NativeContractRepository.RoleManagement.Id, -8);
            Assert.AreEqual(TestBlockchain.TheNeoSystem.NativeContractRepository.Oracle.Id, -9);
        }
        ...
        public void TestContractMethodWithSpecialParameter()
        {
            ...
            foreach (var contract in TestBlockchain.TheNeoSystem.NativeContractRepository.Contracts)
            {
