...
namespace Neo.UnitTests.SmartContract
{
    ...
    public class UT_InteropPrices
    {
        ...
        public void ApplicationEngineFixedPrices()
        {
            ...
            using (ApplicationEngine ae = ApplicationEngine.Create(TriggerType.Application, null, snapshot, TestBlockchain.TheNeoSystem.NativeContractRepository, gas: 0))
            {
        ...
        public void ApplicationEngineRegularPut()
        {
            ...
            snapshot.AddContract(script.ToScriptHash(), contractState, TestBlockchain.TheNeoSystem.NativeContractRepository);

            using ApplicationEngine ae = ApplicationEngine.Create(TriggerType.Application, null, snapshot, TestBlockchain.TheNeoSystem.NativeContractRepository);
        ...
        public void ApplicationEngineReusedStorage_FullReuse()
        {
            ...
            using ApplicationEngine applicationEngine = ApplicationEngine.Create(TriggerType.Application, null, snapshot, TestBlockchain.TheNeoSystem.NativeContractRepository);
