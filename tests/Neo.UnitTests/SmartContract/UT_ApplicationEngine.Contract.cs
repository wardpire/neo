...
namespace Neo.UnitTests.SmartContract
{
    public partial class UT_ApplicationEngine
    {
        ...
        public void TestCreateStandardAccount()
        {
            ...
            using var engine = ApplicationEngine.Create(TriggerType.Application, null, snapshot, TestBlockchain.TheNeoSystem.NativeContractRepository, settings: TestProtocolSettings.Default, gas: 1100_00000000);
        ...
        public void TestCreateStandardMultisigAccount()
        {
            var snapshot = _snapshotCache.CloneCache();
            var settings = TestProtocolSettings.Default;
            using var engine = ApplicationEngine.Create(TriggerType.Application, null, snapshot, TestBlockchain.TheNeoSystem.NativeContractRepository, settings: TestBlockchain.TheNeoSystem.Settings, gas: 1100_00000000);
