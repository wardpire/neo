...
namespace Neo.UnitTests.SmartContract
{
    ...
    public class UT_ContractParameterContext
    {
        ...
        public void TestGetComplete()
        {
            ...
            var context = new ContractParametersContext(snapshotCache, tx, TestProtocolSettings.Default.Network, TestBlockchain.TheNeoSystem.NativeContractRepository);
        ...
        public void TestAdd()
        {
            ...
            var context1 = new ContractParametersContext(snapshotCache, tx, TestProtocolSettings.Default.Network, TestBlockchain.TheNeoSystem.NativeContractRepository);
            ...
            var context2 = new ContractParametersContext(snapshotCache, tx, TestProtocolSettings.Default.Network, TestBlockchain.TheNeoSystem.NativeContractRepository);
        ...
        public void TestAddSignature()
        {
            ...
            context = new ContractParametersContext(snapshotCache, tx, TestProtocolSettings.Default.Network, TestBlockchain.TheNeoSystem.NativeContractRepository);
