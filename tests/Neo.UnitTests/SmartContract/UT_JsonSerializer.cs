...
namespace Neo.UnitTests.SmartContract
{
    ...
    public class UT_JsonSerializer
    {
        ...
        public void Deserialize_WrongJson()
        {
            ...
            ApplicationEngine engine = ApplicationEngine.Create(TriggerType.Application, null, snapshot, TestBlockchain.TheNeoSystem.NativeContractRepository);
        ...
        {
            var snapshot = _snapshotCache.CloneCache();
            ApplicationEngine engine = ApplicationEngine.Create(TriggerType.Application, null, snapshot, TestBlockchain.TheNeoSystem.NativeContractRepository, null, ProtocolSettings.Default);
