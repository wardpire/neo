...
namespace Neo.UnitTests.SmartContract
{
    ...
    public class UT_JsonSerializer
    {
        ...
        {
            ApplicationEngine engine = ApplicationEngine.Create(TriggerType.Application, null, null, TestBlockchain.TheNeoSystem.NativeContractRepository);
        ...
        {
            ApplicationEngine engine = ApplicationEngine.Create(TriggerType.Application, null, null, TestBlockchain.TheNeoSystem.NativeContractRepository, null, ProtocolSettings.Default);
