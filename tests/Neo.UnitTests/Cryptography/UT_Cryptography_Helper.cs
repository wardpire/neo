...
namespace Neo.UnitTests.Cryptography
{
    ...
    public class UT_Cryptography_Helper
    {
        ...
        {
            NEP6Wallet wallet = new NEP6Wallet("", "1", TestProtocolSettings.Default, TestBlockchain.TheNeoSystem.NativeContractRepository);
        ...
        {
            NEP6Wallet wallet = new NEP6Wallet("", "1", ProtocolSettings.Default, TestBlockchain.TheNeoSystem.NativeContractRepository);
            wallet.CreateAccount();
            wallet.CreateAccount();
