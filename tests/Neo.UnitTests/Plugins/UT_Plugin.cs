    ...
    public class UT_Plugin
    {
        ...
        public void TestSendMessage()
        {
            lock (s_locker)
            {
                ...
                Assert.IsFalse(TestBlockchain.TheNeoSystem.PluginRepository.SendMessage("hey1"));

                var lp = new TestPlugin();
                Assert.IsTrue(TestBlockchain.TheNeoSystem.PluginRepository.SendMessage("hey2"));
            }
        }
